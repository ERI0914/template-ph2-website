<?php
    ...
    $sql = "SELECT * FROM quiz_answers WHERE question_id = :question_id";
    $stmt = $dbh->prepare($sql);
    ...
    try {
        ...
        // 問題レコードの更新
        $sql = "UPDATE quiz SET image = :image, content = :content, supplement = :supplement WHERE id = :id";
        $stmt = $dbh->prepare($sql);
        ...
        // 選択肢レコードの更新
        $sql = "UPDATE quiz_answers SET name = :name, valid = :valid WHERE id = :id AND question_id = :question_id";
        // 各選択肢についてループ
    ...
    <div class="wrapper">
        ...
        <div class="container">
            ...
            <div class="mb-4">
            <input type="hidden" name="question_id" value="<?php  $question_id; ?>">
